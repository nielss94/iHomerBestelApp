...
public class RemoveFromOrderConnector extends AsyncTask<Void, Void, Void> {
    ...
    public RemoveFromOrderConnector(Account account, Order order, ArrayList<OrderItem> orderItems) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String http = "https://ihomerapi.herokuapp.com/API/removeFromOrder";
