...
public class ProductDeleteConnector extends AsyncTask<Void, Void, Void> {

    private static final String TAG = "ProductDeleteConnector";
    private Account account;
    private Product product;

    public ProductDeleteConnector(Account account, Product product) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String http = "https://ihomerapi.herokuapp.com/API/deleteProduct";
