...
public class ProductCreateConnector extends AsyncTask<Void, Void, Void> {

    private static final String TAG = "ProductCreateConnector";
    private Account account;
    private Product product;

    public ProductCreateConnector(Account account, Product product) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String http = "https://ihomerapi.herokuapp.com/API/createProduct";
        ...
        try {
            ...
            jsonParam.put("categoryEng", product.getCategoryEng());
            jsonParam.put("nameEng", product.getNameEng());
