...
public class OrderDeleteConnector extends AsyncTask<Void, Void, Void> {

    private static final String TAG = "OrderDeleteConnector";
    private Account account;
    private Order order;

    public OrderDeleteConnector(Account account, Order order) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String http = "https://ihomerapi.herokuapp.com/API/deleteOrder";
